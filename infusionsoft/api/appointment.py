...
class Appointment(ApiModel):
    ...
    def list_appointments(self, params=None):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/listAppointmentsUsingGET>`.
    ...
    def create_appointment(self, json=None):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/createAppointmentUsingPOST>`.
    ...
    def retrieve_appointment(self, appointment_id):
        ...
        The authenticated user will need the "can view all records" permission for Task/Appt/Notes.
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/getAppointmentUsingGET>`.
    ...
    def update_appointment(self, appointment_id, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/updatePropertiesOnAppointmentUsingPATCH>`.
    ...
    def replace_appointment(self, appointment_id, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/updateAppointmentUsingPUT>`.
    ...
    def replace_appointment_model(self):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/retrieveAppointmentModelUsingGET>`.
    ...
    def create_custom_field(self, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Appointment/createAppointmentCustomFieldUsingPOST>`.
