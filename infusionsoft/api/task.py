...
class Tasks(ApiModel):
    ...
    def create_task(self, json):
        """Creates a new task as the authenticated user. NB: Contact must contain at least one item in the fields title and due_date. All other attributes are optional. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/createTaskUsingPOST>`
    ...
    def delete_task(self, task_id):
        """Remove a tag from a list of contacts. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/deleteTaskUsingDELETE>`
    ...
    def retrieve_task(self, task_id):
        """Retrieves a single tag. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/getTaskUsingGET>`
    ...
    def update_task(self, task_id, json):
        """Updates a task with only the values provided in the request. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/updatePropertiesOnTaskUsingPATCH>`
    ...
    def replace_task(self, task_id, json):
        """Replaces a task with the values provided in the request. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/updateTaskUsingPUT>`
    ...
    def retrieve_task_model(self):
        """Get the custom fields for the Task object. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/retrieveTaskModelUsingGET>`
    ...
    def create_custom_field(self, json):
        """Adds a custom field of the specified type and options to the Task object. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/createTaskCustomFieldUsingPOST>`
    ...
    def search_tasks(self, params):
        """Retrieves Tasks belonging to the authenticated user using the specified search criteria. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Task/listTasksForCurrentUserUsingGET>`
