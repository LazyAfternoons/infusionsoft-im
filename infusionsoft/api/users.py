...
class Users(ApiModel):
    ...
    def list_users(self, params=None):
        """Retrieves a list of all users. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Users/listUsersUsingGET>`.
    ...
    def create_user(self, json):
        """Creates a new user record. NB: Users will be invited to the application and remain in the "Invited" status until the user accepts the invite. "Inactive" users will not take up a user license. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Users/createUserUsingPOST>`.
    ...
    def get_user_email_signature(self, user_id):
        """Retrieves a HTML snippet that contains the user's email signature. `API reference <https://developer.infusionsoft.com/docs/rest/#!/Users/getUserSignatureUsingGET>`.
