...
class Email(ApiModel):
    ...
    def create_email_record(self, json):
        """Retrieve a list of emails that have been sent.
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/createEmailUsingPOST>`
    ...
    def delete_email_record(self, email_id):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/deleteEmailUsingDELETE>`.
    ...
    def retrieve_email_record(self, email_id):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/getEmailUsingGET>`.
    ...
    def update_email_record(self, email_id, json):
        ...
        Warning: DEPRECATED.
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/updateEmailUsingPUT>`
    ...
    def send_email(self, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/sendEmailUsingPOST>`
    ...
    def create_set_email_records(self, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/createEmailsUsingPOST>`
    ...
    def unsync_batch_email_records(self, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Email/deleteEmailsUsingPOST>`
