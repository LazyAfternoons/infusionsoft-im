...
class Campaign(ApiModel):
    ...
    def list_campaigns(self, params=None):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/listCampaignsUsingGET>`.
    ...
    def retrieve_campaign(self, campaign_id, params=None):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/getCampaignUsingGET>`.
    ...
    def remove_multiple_campaign_sequence(self, campaign_id, sequence_id, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/removeContactsFromCampaignSequenceUsingDELETE>`.
    ...
    def add_multiple_campaign_sequence(self, campaign_id, sequence_id, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/addContactsToCampaignSequenceUsingPOST>`.
    ...
    def remove_campaign_sequence(self, campaign_id, sequence_id, contact_id):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/removeContactFromCampaignSequenceUsingDELETE>`.
    ...
    def add_campaign_sequence(self, campaign_id, sequence_id, contact_id):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/addContactToCampaignSequenceUsingPOST>`.
    ...
    def achieve_api_goal(self, integration, call_name, json):
        ...
        `API reference <https://developer.infusionsoft.com/docs/rest/#!/Campaign/createAchieveApiGoalEventUsingPOST>`.
